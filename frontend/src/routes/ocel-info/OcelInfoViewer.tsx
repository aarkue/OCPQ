  ...
  return (
    <div className="my-4 text-lg text-left">
      ...
      <div className="font-medium mt-4 mb-3 bg-fuchsia-50 p-3 rounded border border-fuchsia-100">
        ...
        <div className="ml-2">
          <p>Create custom queries to freely explore the dataset.
            <span className="text-sm italic font-normal mb-1 block">How many orders are delivered late? Which customers have the most payment reminders?</span>
          </p>
          <Link to="/constraints">
        ...
        <div className="ml-2">
          <p className="mt-2">Discover and analyze behavioral patterns.
            <span className="text-sm italic font-normal mb-1 block">What happens after an order is placed? Is the same employee placing an order also confirming it?</span>
          </p>
      ...
      <div className="grid grid-cols-[1fr_1fr] gap-x-2 mb-2">
        ...
        <MenuLink to={"/"} classNames="text-xs text-center w-fit border-transparent bg-sky-50 hover:bg-sky-100">Load another dataset</MenuLink>
