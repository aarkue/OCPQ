...
import FilterChooserDialog from "../box/FilterChooserDialog";
		...
		<ContextMenu>
			...
			>
				...
				>
					...
					{violations !== undefined &&
						(violations.situationViolatedCount > 0 || data.box.constraints.length >= 1) && (
			...
			<AlertDialog open={deleteAlertOpen} onOpenChange={(op) => setDeleteAlertOpen(op)}>
				<AlertDialogContent>
					<AlertDialogHeader>
						...
						<AlertDialogDescription>
							This node and all contained variables, filters, and constraints will be deleted. This
