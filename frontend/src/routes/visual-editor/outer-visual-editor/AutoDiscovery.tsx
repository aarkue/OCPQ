			...
			initialData={
				{
					countConstraints: {
						coverFraction: 0.85,
						objectTypes: ocelInfo.object_types.length > 0 ? [ocelInfo.object_types[0].name] : [],
						eventTypes: ocelInfo.event_types.length > 0 ? [ocelInfo.event_types[0].name] : [],
						enabled: true,
					},
									...
									<h3 className="text-lg text-gray-900 flex gap-x-2 items-center">
										...
										<Switch
											...
											onClick={(ev) => {
												ev.preventDefault();
												const newData = { ...data };
												newData.countConstraints.enabled = !newData.countConstraints.enabled;
								...
								<AccordionContent>
									...
									>
										...
										<ul className="flex flex-col mb-1 list-disc ml-6 text-base">
											{data.countConstraints.objectTypes.map((ot) => (
												<li key={ot}>
														...
														<button
															...
															onClick={() => {
																setData({
																	...
																	countConstraints: {
																		...data.countConstraints,
																		objectTypes: data.countConstraints.objectTypes.filter(
																			(x) => x !== ot,
																		),
																	},
																});
										...
										<Combobox
											...
											options={ocelInfo.object_types
												.filter((ot) => !data.countConstraints.objectTypes.includes(ot.name))
												.map((ot) => ({
													value: ot.name,
													label: ot.name,
												}))}
											onChange={(value) => {
												setData({
													...
													countConstraints: {
														...data.countConstraints,
														objectTypes: [...data.countConstraints.objectTypes, value],
													},
												});
											}}
										...
										<ul className="flex flex-col mb-1 list-disc ml-6 text-base">
											{data.countConstraints.eventTypes.map((ot) => (
												<li key={ot}>
													<div className="flex gap-x-2 items-center">
														{ot}
														<button
															...
															onClick={() => {
																setData({
																	...
																	countConstraints: {
																		...data.countConstraints,
																		eventTypes: data.countConstraints.eventTypes.filter(
																			(x) => x !== ot,
																		),
																	},
																});
										...
										<Combobox
											...
											options={ocelInfo.event_types
												.filter((ot) => !data.countConstraints.eventTypes.includes(ot.name))
												.map((ot) => ({
													value: ot.name,
													label: ot.name,
												}))}
											onChange={(value) => {
												setData({
													...
													countConstraints: {
														...data.countConstraints,
														eventTypes: [...data.countConstraints.eventTypes, value],
													},
												});
											}}
											name={"Add event type..."}
							...
							<AccordionItem value="eventuallyFollowsConstraints">
								...
								<AccordionContent>
									<div
										className={clsx(
											"ml-2 pl-2 border-l-2",
											!data.eventuallyFollowsConstraints.enabled && "text-gray-400",
										)}
									>
										<Label>Cover Fraction</Label>
										<Input
										...
										<Label className="mt-3 mb-1 block">Object Types</Label>
										<ul className="flex flex-col mb-1 list-disc ml-6 text-base">
											{data.eventuallyFollowsConstraints.objectTypes.map((ot) => (
												<li key={ot}>
													<div className="flex gap-x-2 items-center">
														{ot}
														<button
															...
															onClick={() => {
																setData({
																	...
																	eventuallyFollowsConstraints: {
																		...data.eventuallyFollowsConstraints,
																		objectTypes:
																			data.eventuallyFollowsConstraints.objectTypes.filter(
																				(x) => x !== ot,
																			),
																	},
																});
										...
										<Combobox
											...
											options={ocelInfo.object_types
												.filter(
													(ot) => !data.eventuallyFollowsConstraints.objectTypes.includes(ot.name),
												)
												.map((ot) => ({
													value: ot.name,
													label: ot.name,
											...
											onChange={(value) => {
												setData({
													...
													eventuallyFollowsConstraints: {
														...data.eventuallyFollowsConstraints,
														objectTypes: [...data.eventuallyFollowsConstraints.objectTypes, value],
													},
												});
											}}
											name={"Add object type..."}
							...
							<AccordionItem value="orConstraints">
									...
									<h3 className="text-lg text-gray-900 flex gap-x-2 items-center">
										...
										<Switch
											...
											onClick={(ev) => {
												ev.preventDefault();
												const newData = { ...data };
												newData.orConstraints.enabled = !newData.orConstraints.enabled;
								...
								<AccordionContent>
									...
									>
										...
										<Label className="mt-3 mb-1 block">Object Types</Label>
										<ul className="flex flex-col mb-1 list-disc ml-6 text-base">
											{data.orConstraints.objectTypes.map((ot) => (
												<li key={ot}>
													<div className="flex gap-x-2 items-center">
														{ot}
														<button
															...
															onClick={() => {
																setData({
																	...
																	orConstraints: {
																		...data.orConstraints,
																		objectTypes: data.orConstraints.objectTypes.filter(
																			(x) => x !== ot,
																		),
																	},
																});
										...
										<Combobox
											disabled={!data.orConstraints.enabled}
											options={ocelInfo.object_types
												.filter((ot) => !data.orConstraints.objectTypes.includes(ot.name))
												.map((ot) => ({
													value: ot.name,
													label: ot.name,
												}))}
											onChange={(value) => {
												setData({
													...
													orConstraints: {
														...data.orConstraints,
														objectTypes: [...data.orConstraints.objectTypes, value],
													},
												});
											}}
											name={"Add object type..."}
										...
										<Label className="mt-3 mb-1 block">Event Types</Label>
										<ul className="flex flex-col mb-1 list-disc ml-6 text-base">
											{data.orConstraints.eventTypes.map((ot) => (
												<li key={ot}>
													<div className="flex gap-x-2 items-center">
														{ot}
														<button
															...
															onClick={() => {
																setData({
																	...
																	orConstraints: {
																		...data.orConstraints,
																		eventTypes: data.orConstraints.eventTypes.filter(
																			(x) => x !== ot,
																		),
																	},
																});
										...
										<Combobox
											disabled={!data.orConstraints.enabled}
											options={ocelInfo.event_types
												.filter((ot) => !data.orConstraints.eventTypes.includes(ot.name))
												.map((ot) => ({
													value: ot.name,
													label: ot.name,
												}))}
											onChange={(value) => {
												setData({
													...
													orConstraints: {
														...data.orConstraints,
														eventTypes: [...data.orConstraints.eventTypes, value],
													},
												});
											}}
											name={"Add event type..."}
					...
					.promise(
						backend["ocel/discover-constraints"](reqData).then(async (json) => {
							...
							for (const [name, newConstraint] of json.constraints) {
								...
								const [ns, es] = bindingBoxTreeToNodes(newConstraint, 0, 0, 0, v4());
