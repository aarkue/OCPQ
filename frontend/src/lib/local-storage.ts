...
export const DATA_EXTRACTION_LOCALSTORAGE_SAVE_KEY_DATA = "oced-data-extraction-data-";
export const DATA_EXTRACTION_LOCALSTORAGE_SAVE_KEY_META = "oced-data-extraction-meta";
