...
/** Dev-only smoke page for the propel components. Lazy plus a `DEV` guard, so neither the route nor
 *  the component reaches a production bundle -- it used to be a plain static import registered as a
 *  real route, which shipped it. */
