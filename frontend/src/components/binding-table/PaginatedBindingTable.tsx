...
export function DataTablePagination<TData, TValue>({
	...
	}, [initialMode, table.getAllColumns, table.getColumn]);
	return (
												...
												{header.id === "Violation" && (
													<>
														<IndeterminateCheckbox
															title={
																table.getColumn(header.id)?.getFilterValue() === "SATISFIED"
																	? "Only show satisfied bindings"
																	: table.getColumn(header.id)?.getFilterValue() === "VIOLATED"
														...
														/>
														{table.getColumn(header.id)?.getFilterValue() === undefined
															? "any"
															: table.getColumn(header.id)?.getFilterValue() === "VIOLATED"
																? "viol."
																: "sat."}
